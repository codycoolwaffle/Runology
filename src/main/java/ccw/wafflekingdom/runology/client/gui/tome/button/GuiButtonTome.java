...
public class GuiButtonTome extends GuiButton
{
	public GuiButtonTome(int id, int x, int y, int width, int height, String text)
	{
	...
	{
		handler.playSound(PositionedSoundRecord.getMasterRecord(ModSounds.tomePage, 1.0F));
	}
	*/
}
